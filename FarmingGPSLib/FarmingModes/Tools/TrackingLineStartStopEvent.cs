...
namespace FarmingGPSLib.FarmingModes.Tools
{
    public class TrackingLineStartStopEvent : TrackingLine, IFarmingEvent
    {
        ...
        public TrackingLineStartStopEvent(ILineString line, double startEventDistance, double stopEventDistance) : base(line)
        {
            ...
            _events[0].Left = new Angle(MainLine.Angle + (Math.PI / 4.0));
            _events[0].Right = new Angle(MainLine.Angle - (Math.PI / 4.0));
            ...
            _events[1].Left = new Angle(MainLine.Angle + (Math.PI / 4.0));
            _events[1].Right = new Angle(MainLine.Angle - (Math.PI / 4.0));
            ...
            _events[2].Left = new Angle(MainLine.Angle - ((Math.PI / 2.0) + (Math.PI / 4.0)));
            _events[2].Right = new Angle(MainLine.Angle + ((Math.PI / 2.0) + (Math.PI / 4.0)));
            ...
            _events[3].Left = new Angle(MainLine.Angle - ((Math.PI / 2.0) + (Math.PI / 4.0))); 
            _events[3].Right = new Angle(MainLine.Angle + ((Math.PI / 2.0) + (Math.PI / 4.0)));
