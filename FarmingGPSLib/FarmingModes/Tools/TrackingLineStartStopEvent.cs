...
namespace FarmingGPSLib.FarmingModes.Tools
{
    public class TrackingLineStartStopEvent : TrackingLine, IFarmingEvent
    {
        ...
        public TrackingLineStartStopEvent(ILineString line, double startEventDistance, double stopEventDistance) : base(line)
        {
            ...
            _events[2].Left.DegreesPos = new Angle(MainLine.Angle).DegreesPos + 225.0;
            _events[2].Right.DegreesPos = new Angle(MainLine.Angle).DegreesPos + 135.0;
            ...
            _events[3].Left.DegreesPos = new Angle(MainLine.Angle).DegreesPos + 225.0;
            _events[3].Right.DegreesPos = new Angle(MainLine.Angle).DegreesPos + 135.0;
