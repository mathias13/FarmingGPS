...
namespace FarmingGPSLib.Settings.BogBalle
{
    public class Calibrator : ConfigurationSection, ISettingsCollection
    {
        ...
        public Calibrator()
        {
            _settings = new SettingsCollection("Calibrator");
        ...
        public Calibrator(Calibrator calibratorSettings) : this()
        {
            COMPort = calibratorSettings.COMPort;
            ReadInterval = calibratorSettings.ReadInterval;
